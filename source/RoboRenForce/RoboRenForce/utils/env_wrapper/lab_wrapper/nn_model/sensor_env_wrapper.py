import torch
from ..vecenv_wrapper import RoboRenForceLabEnvWrapper
from typing import TYPE_CHECKING


class RFSensorEnvWrapper(RoboRenForceLabEnvWrapper):
    ...
    def dim_params(self):
        dim_params = {
            ...
            "slow_dim": self.observation_space.get("slow").shape[-1],
