...
from RoboRenForce.prototype.embodied.robot import RobotCfg
from RoboRenForce.prototype.embodied.transforms.base_transform import DataTransformCfg
...
class DatasetEntryCfg(ClassTemplateBaseCfg):
    ...
    Concrete entries set default values in task packages (source/tasks/RRF_*). Example:
