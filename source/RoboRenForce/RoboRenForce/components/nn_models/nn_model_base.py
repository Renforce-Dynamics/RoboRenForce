...
from RoboRenForce.utils.template import ClassTemplateBase
from abc import abstractmethod

class NNModelBase(nn.Module, ClassTemplateBase):
    def __init__(
            self, cfg: NNModelBaseCfg, 
            *args, **kwargs
        ):
        super().__init__()
        self.cfg = cfg
...
@configclass
class NNModelBaseCfg(ModuleBaseCfg):
    class_type      : type[nn.Module] = NNModelBase
    use_amp         : bool = True
