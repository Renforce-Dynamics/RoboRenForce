...
Unlike nn models that use latent variables, system dynamics work with explicit
...
class SystemDynamicsBase(nn.Module, ABC):
    ...
    def __init__(
        ...
        Args:
            state_dim: Dimension of system dynamic state (kept for backward compatibility, use dynamic_dim alias)
    ...
    def compute_loss(
        ...
        Returns:
            7-tuple of loss scalars compatible with SystemDynamicsTrainer.update_system_dynamics
        """
        pass
