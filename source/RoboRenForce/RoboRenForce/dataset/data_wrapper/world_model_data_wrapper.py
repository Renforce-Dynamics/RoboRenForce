...
class WorldModelDataWrapper(OfflineDataWrapperBase):
    ...
    Used for world model training. Provides batches of (s, a, r, s', done) sequences.
    """
    ...
    def get_batch(
        ...
        **kwargs
        ...
        """Get a batch of data for world model training.
        ...
        for _ in range(batch_size):
            ...
            if dynamic_seq is None:
                raise ValueError("'dynamic' or 'policy' field is required for world model training")
            
            action_seq = traj.get("action")
            if action_seq is None:
                raise ValueError("'action' field is required for world model training")
...
class WorldModelDataWrapperCfg(OfflineDataWrapperBaseCfg):
    """Configuration for world model data wrapper."""
