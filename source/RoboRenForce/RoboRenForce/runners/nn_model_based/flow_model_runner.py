...
class FlowModelRunner(NNModelBasedRunner):
    """On-policy runner that trains belief flow models as nn models.
...
from RoboRenForce.algorithms.nn_model_trainer.flow_model_trainer import FlowModelTrainerCfg
...
@configclass
class FlowModelRunnerCfg(NNModelBasedRunnerCfg):
    ...
    nn_model_cfg: components.nn_models.BeliefFlowModelCfg = MISSING
    
    # Belief observation updater
    belief_updater_cfg: components.nn_models.BeliefUpdaterCfg = MISSING
