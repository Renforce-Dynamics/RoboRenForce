...
from RoboRenForce.components.world_models import system_dynamics
from RoboRenForce.runners.offline import \
    OfflineRunnerBase, OfflineRunnerBaseCfg
from RoboRenForce.components.world_models.system_dynamics import \
    SystemDynamicsBase, SystemDynamicsBaseCfg
from RoboRenForce.algorithms.world_model_trainer import \
    SystemDynamicsTrainer, SystemDynamicsTrainerCfg

class OfflineSystemDynamicsRunner(OfflineRunnerBase):
    """Offline world model training runner.
    ...
    def init_components(self):
        """Initialize components for world model training."""
