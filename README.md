...
|----------|---------|----------------|----------|--------|
| **MJLab** (MuJoCo Warp) | [`RRF_mjlab`](source/tasks/RRF_mjlab/) | Go1, G1 — velocity tracking (flat/rough) | Online RL | [`train_mjlab.py`](scripts/renforce/train_mjlab.py) |
| **Isaac Lab** (Isaac Sim) | [`RRF_isaaclab`](source/tasks/RRF_isaaclab/) | A1, Go1, Go2, Anymal B/C/D, H1, G1 | Online RL | [`train_lab.py`](scripts/renforce/train_lab.py) |
| **Gymnasium** | Built-in | Classic control, MuJoCo | Online RL | [`train_gym.py`](scripts/renforce/train_gym.py) |
| **D4RL** | [`RRF_d4rl`](source/tasks/RRF_d4rl/) | Walker2d, Hopper, HalfCheetah | Offline RL | [`OfflineRunnerBase`](source/RoboRenForce/RoboRenForce/runners/offline/) |
| **LIBERO** | [`RRF_libero`](source/tasks/RRF_libero/) | Franka — 10/90/130 manipulation tasks | VLA Pretrain / VLA RL | [`train_vla_benchmark.py`](scripts/vla/rl/train_vla_benchmark.py) |
| **ManiSkill** | [`RRF_maniskill`](source/tasks/RRF_maniskill/) | Franka — GPU-accelerated manipulation | VLA Pretrain / VLA RL | [`train_vla_benchmark.py`](scripts/vla/rl/train_vla_benchmark.py) |
| **CALVIN** | [`RRF_calvin`](source/tasks/RRF_calvin/) | Franka — 5-subtask long-horizon eval | VLA Pretrain / VLA RL | [`train_vla_benchmark.py`](scripts/vla/rl/train_vla_benchmark.py) |
...
| **Humanoid Psi0** | [`RRF_humanoid_psi0`](source/tasks/RRF_humanoid_psi0/) | G1 Dex3 — 14 pick-and-place demos | VLA Pretrain | [`train_single_gpu.py`](scripts/vla/pretrain/train_single_gpu.py) |
